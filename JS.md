...
Желательно использовать тернарные выражение как можно меньше в обычном JavaScript коде.
...
В случае многострочного тернарного выражения, выравнивание кода должно быть на 1 отступ глубже.
...
соответственно, если компонент имеет необязательные параметры, **необходимо** заполнить для них параметры по умолчанию (`defaultProps`).
